...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/mnt/sda-20T/rj/data/nuscenes/anno_file/SurroundOcc/nuscenes_infos_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file='/mnt/sda-20T/rj/data/nuscenes/anno_file/SurroundOcc/nuscenes_infos_val.pkl',
...
# bash ./tools/dist_train.sh ./projects/configs/surroundocc/surroundocc.py 8 /mnt/sda-20T/rj/exp_out/myocc_out/sur_5.0/output/ > /mnt/sda-20T/rj/exp_out/myocc_out/sur_5.0/log/train.txt 2> /mnt/sda-20T/rj/exp_out/myocc_out/sur_5.0/log/error.txt